...
function addNamespacesToAssertion(xml) {
  ...
  if (assertions.length !== 1) {
    var err = new Error('passport-saml sam.js addNamespacesToAssertion found multiple assertions');
    //adding the assertinos onto the error object for debugz.
    err.errorData =  assertions;
    throw err;
  }
